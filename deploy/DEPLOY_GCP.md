...
- **権威 NS の不一致の直し方（c\* vs e\*・カスタム NS / カスタム A）:** [`deploy/DNS_AUTHORITY_FIX.md`](./DNS_AUTHORITY_FIX.md)
- **NS 委任（e1〜e4）＋レコード複製済み後の Cline 手順:** [`deploy/CLINE_HANDOFF_NS_DELEGATION.md`](./CLINE_HANDOFF_NS_DELEGATION.md)
- **新プロジェクト DNS / Certbot / OAuth 移行:** [`deploy/MEET_NEW_PROJECT_DNS_OAUTH.md`](./MEET_NEW_PROJECT_DNS_OAUTH.md)
- **Slack アプリ設定を ngrok から meet.humbull.co へ:** [`deploy/SLACK_APP_CLOUD_MIGRATION.md`](./SLACK_APP_CLOUD_MIGRATION.md)
